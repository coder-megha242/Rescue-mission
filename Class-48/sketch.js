...
function draw(){
    ...
    //console.log(trialPlayer.x + "x");
    //console.log(trialPlayer.y + "y");
    ...
    if(trialPlayer.x > 1500 && trialPlayer.x < 3000 && trialPlayer.y > 0 && trialPlayer.y < 750){
    ...
    if(trialPlayer.x > 1500 && trialPlayer.x < 3000 && trialPlayer.y > 750 && trialPlayer.y < 1500){
    ...
    if(trialPlayer.x > 3000 && trialPlayer.x < 4500){

        camera.x = 3750;

        if(trialPlayer.y > -425 && trialPlayer.y < 1125){

            camera.y = trialPlayer.y;
